...
| TA-X6 | Not started | None | Provisional customer/break observations, reviewed posted transactions and adjustments, atomic commercial-state/event linkage, source reconciliation and double-count prevention |
