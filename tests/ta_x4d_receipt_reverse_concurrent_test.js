...
async function main() {
  ...
  try {
    ...
    await setup.query("insert into public.e10_purchase_order_lines(id,organization_id,purchase_order_id,configuration_version_id,line_no,ordered_quantity) values($1,$2,$3,$4,1,5)",[x.pol,org,x.po,x.config]);
    ...
    console.log('TA-X4d receipt reversal race: PASS (post-lock reservation reread prevents on-hand below reserved)');
  } finally {
