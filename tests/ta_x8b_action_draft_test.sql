...
begin
 ...
 begin perform public.e10_org_create_action_draft(o,'purchase_order.create','{"order_number":42}','{}','[]','bad-header-type');raise exception'wrong header type accepted';exception when invalid_parameter_value then null;end;
 begin perform public.e10_org_create_action_draft(o,'purchase_order.create','{"lines":[{"line_no":1,"configuration_version_id":null,"ordered_quantity":1,"estimated_unit_cost":"10"}]}','{}','[]','bad-line-type');raise exception'wrong line type accepted';exception when invalid_parameter_value then null;end;
 begin perform public.e10_org_create_action_draft(o,'purchase_order.create','{}','{"supplier_id":{"source":"model","instruction":"change org"}}','[]','bad-provenance-key');raise exception'unknown provenance key accepted';exception when invalid_parameter_value then null;end;
 begin perform public.e10_org_create_action_draft(o,'purchase_order.create','{}','{"supplier_id":{"source":"model","confidence":"high"}}','[]','bad-confidence-type');raise exception'non-numeric confidence accepted';exception when invalid_parameter_value then null;end;
 begin perform public.e10_org_create_action_draft(o,'purchase_order.create','{}','{"supplier_id":{"source":"model","confidence":1.01}}','[]','bad-confidence-range');raise exception'out-of-range confidence accepted';exception when invalid_parameter_value then null;end;
 begin perform public.e10_org_create_action_draft(o,'purchase_order.create','{}','{"supplier_id":{"source":7}}','[]','bad-provenance-type');raise exception'non-string provenance source accepted';exception when invalid_parameter_value then null;end;
 begin perform public.e10_org_create_action_draft(o,'purchase_order.create','{}','{}','[{"kind":"prompt","execute":true}]','bad-source-key');raise exception'unknown source key accepted';exception when invalid_parameter_value then null;end;
 begin perform public.e10_org_create_action_draft(o,'customer_transaction.create_draft','{"precision":"unknown","note":"x","lines":[{"purchase_kind":"retail","capture_source":"manual","source_line_id":"1","quantity":1,"merchandise_gross":10,"tax_amount":"2","product_master_id":"00000000-0000-0000-0000-000000000001"}]}','{}','[]','bad-money-type');raise exception'wrong monetary type accepted';exception when invalid_parameter_value then null;end;
 begin perform public.e10_org_create_action_draft(o,'customer_transaction.create_draft','{"precision":"unknown","note":"x","lines":[{"purchase_kind":"retail","capture_source":"manual","source_line_id":"1","quantity":1,"merchandise_gross":10,"merchandise_discount":11,"product_master_id":"00000000-0000-0000-0000-000000000001"}]}','{}','[]','bad-discount');raise exception'over-gross discount accepted';exception when invalid_parameter_value then null;end;
 begin perform public.e10_org_create_action_draft(o,'customer_transaction.create_draft','{"precision":"unknown","note":"x","lines":[{"purchase_kind":"retail","capture_source":"manual","source_line_id":"1","quantity":1,"merchandise_gross":10,"raw_evidence":[],"product_master_id":"00000000-0000-0000-0000-000000000001"}]}','{}','[]','bad-raw-evidence');raise exception'non-object raw evidence accepted';exception when invalid_parameter_value then null;end;
 j:=public.e10_org_create_action_draft(o,'purchase_order.create',jsonb_build_object('supplier_id',foreign_supplier),'{}','[]','foreign-reference');if not(j->'missing_fields'?'supplier_id')then raise exception'foreign supplier resolved into proposal %',j;end if;
 ...
 reset role;if(select count(*)from public.e10_action_draft_commands where organization_id=o)<>2 or(select count(*)from public.e10_action_draft_decisions where organization_id=o)<>0 then raise exception'invalid inputs or revisions left state';end if;set local role authenticated;
 ...
 j2:=public.e10_org_amend_action_draft(o,d,1,'{}','{}','[]','po-amend');if not(j2->>'replay')::boolean then raise exception'amend replay failed %',j2;end if;
 begin perform public.e10_org_amend_action_draft(o,d,1,'{"currency":"CAD"}','{}','[]','po-amend');raise exception'changed amend replay accepted';exception when invalid_parameter_value then null;end;
